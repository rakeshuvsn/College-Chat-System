...
export class AdminComponent implements OnInit {
  ...
  registerFaculty() {
    if (this.facultyForm.valid) {
      ...
      this.adminService.registerFaculty(this.facultyForm.value).subscribe(isSuccess => {
        if (isSuccess) {
  ...
  registerStudent() {
    if (this.studentForm.valid) {
      this.loadingService.isLoading.next(true);
      this.adminService.registerStudent(this.studentForm.value).subscribe(isSuccess => {
        if (isSuccess) {
